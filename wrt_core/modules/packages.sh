...
remove_unwanted_packages() {
    ...
    local packages_net=(
        ...
        "dae" "daed" "mihomo" "geoview" "open-app-filter" "msd_lite" "tailscale"
    )
...
install_custom_feed() {
    ...
    local base_custom_feed_packages=(
        ...
        msd_lite luci-app-msd_lite cups luci-app-cupsd dae daed daed-geoip daed-geosite luci-app-daed
    )
...
verify_custom_feed_installed_paths() {
    ...
    local required_package_dirs=(
        ...
        luci-app-passwall nikki luci-app-nikki mihomo-meta tailscale luci-app-tailscale luci-app-daed
    )
